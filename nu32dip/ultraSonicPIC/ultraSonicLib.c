...
void init_ultra()
{
    ...
    // b8 as input to echo pin of UltraSonic Sensor
    TRISBbits.TRISB8 = 1;
    TRISBbits.TRISB6 = 0;
    TRIG = 0;
}
...
unsigned int read_ultra()
{
    ...
    while(PORTBbits.RB8 == 0){} // While pin low wait for echo pin to start listening to wave
    _CP0_SET_COUNT(0);
    // Wait for echo pin to go low
    while(PORTBbits.RB8 == 1){} // While pin high wait for ultra sonic wave to be sensed
